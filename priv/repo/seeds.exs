...
Repo.insert!(%Users{username: "Gustavo", birth_date: ~D[1955-07-01]})
Repo.insert!(%Users{username: "Lucia",birth_date: ~D[1999-01-01]})

# --- Monedas ---
btc = Repo.insert!(%Money{name: "BTC", price: 55000.0})
Repo.insert!(%Money{name: "ETH", price: 3000.0})
Repo.insert!(%Money{name: "ARS", price: 0.0012})
Repo.insert!(%Money{name: "USD", price: 1.0})
Repo.insert!(%Money{name: "EUR", price: 1.18})
